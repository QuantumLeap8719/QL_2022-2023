...
public class RedRightBackup extends LinearOpMode {
    ...
    public static Pose2d BACKUP_HIGHDEPOSIT = new Pose2d(25.5, -44.5, Math.toRadians(-132)); //SECOND HIGH
    public static Pose2d BACKUP_HIGHDEPOSIT_4_5 = new Pose2d(23.5, -44.5, Math.toRadians(-132)); //SECOND HIGH
    ...
    public static Pose2d GRAB_STONE2 = new Pose2d(-26.75, -49.75, Math.toRadians(-90));
    public static Pose2d GRAB_STONE3 = new Pose2d(-27, -50.5, Math.toRadians(-90));
    public static Pose2d GRAB_STONE4 = new Pose2d(-27, -50.5, Math.toRadians(-90));
    public static Pose2d GRAB_STONE5 = new Pose2d(-27, -51, Math.toRadians(-90));
