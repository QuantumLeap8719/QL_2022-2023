...
public class RedRightBackup extends LinearOpMode {
    ...
    //Low Junction Clearance
    public static Pose2d CLEAR = new Pose2d(-10.5 , -42, Math.toRadians(0));
    public static Pose2d START = new Pose2d(0 , 0, 0);

    //First Deposit
    public static Pose2d STRAFE = new Pose2d(-0.2, -51, Math.toRadians(-35));


    //Middle
    public static Pose2d MID_DEPOSIT = new Pose2d(-1.299, -45.185, Math.toRadians(-125)); //MID

    //Middle High
    public static Pose2d BACKUP_HIGHDEPOSIT = new Pose2d(23, -44.5, Math.toRadians(-132)); //SECOND HIGH
    //Curve Point for Middle and PreLoad
    ...
    //Curve Point for Middle High
    public static Pose2d CURVE_FORBACKUPHIGH = new Pose2d(6.669, -52.358, Math.toRadians(-90)); //Curve

    //Grab Positions
    public static Pose2d GRAB_STONE = new Pose2d(-29, -49.5, Math.toRadians(-90));
    public static Pose2d GRAB_STONE2 = new Pose2d(-29, -49, Math.toRadians(-90));
    public static Pose2d GRAB_STONE3 = new Pose2d(-29, -49, Math.toRadians(-90));
    public static Pose2d GRAB_STONE4 = new Pose2d(-29, -48.5, Math.toRadians(-90));
    public static Pose2d GRAB_STONE5 = new Pose2d(-29, -48, Math.toRadians(-90));
