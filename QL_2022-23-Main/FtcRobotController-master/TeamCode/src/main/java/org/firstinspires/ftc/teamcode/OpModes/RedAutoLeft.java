...
public class RedAutoLeft extends LinearOpMode {
    ...
    public Pose2d INTAKE_CLEAR = new Pose2d(-8, -46, Math.toRadians(90));
        ...
        while (opModeIsActive()) {
            ...
            switch (mRobotState) {
                ...
                case DRIVE_TO_DEPOSIT_HIGH_FAR:
                    ...
                    points.add(new CurvePoint(GRAB,1.0,1.0,10));
                    points.add(new CurvePoint(BACK_AT_DEPOSIT_ONE,0.6,0.6,10));
                    points.add(new CurvePoint(DEPOSIT_HIGH,0.4,0.4,10));
